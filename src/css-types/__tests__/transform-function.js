...
describe("Test CSS Type: <transform-function>", () => {
  ...
  describe("Test <translate3d> function", () => {
    test("valid uses", () => {
      expect(
        TransformFunction.parse.parseToEnd("translate3d(  0,0, 1px)")
      ).toEqual(new Translate3d(new Length(0), new Length(0), new Px(1)));
      expect(
        TransformFunction.parse.parseToEnd("translate3d(1.5px, 2em,\n0.5px)")
